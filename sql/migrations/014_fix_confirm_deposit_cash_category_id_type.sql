-- 014_fix_confirm_deposit_cash_category_id_type.sql
-- cash_categories.id is bigint in the production schema. Older deposit RPC
-- migrations declared v_cat_id as uuid, so category id values such as 12
-- failed with: invalid input syntax for type uuid: "12".
